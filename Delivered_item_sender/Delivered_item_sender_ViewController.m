//
//  Delivered_item_sender_ViewController.m
//  Pigeonship
//
...
#import "Utility.h"
@interface Delivered_item_sender_ViewController ()

@end

@implementation Delivered_item_sender_ViewController
...
-(void)CalltheServer
{
    ...
    if ([API connectedToInternet]==YES) {
        ...
        if ([[dict valueForKey:@"status"] isEqualToString:@"true"]) {
            ...
            textlable.text = [NSString stringWithFormat:@"Total %lu items are Delivered",(unsigned long)[[dict valueForKey:@"data"]count]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
 ...
 //   Pack_type_dyn_LB.text= [[[dict valueForKey:@"data"]objectAtIndex:indexPath.row]valueForKey:@"Package_Type"];
   ...
   [Delivered_Before_str_LB setFrame:CGRectMake((mtable_bacground.frame.size.width-15)-120,Middle_Right_Address_LB.frame.origin.y+Middle_Right_Address_LB.frame.size.height+2,120, 30)];
    ...
    DELIVERED_ON_LB_DYN.text= [[[dict valueForKey:@"data"]objectAtIndex:indexPath.row]valueForKey:@"Package_DeliveredOn"];
    DELIVERED_ON_LB_DYN.textColor=[UIColor whiteColor];
...
{
    Delivered_item_sender_detail *objItem_Detail_ViewController=[[Delivered_item_sender_detail alloc]init];
