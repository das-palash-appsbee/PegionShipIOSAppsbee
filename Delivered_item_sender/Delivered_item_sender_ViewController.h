//
//  Delivered_item_sender_ViewController.h
//  Pigeonship
//
...
@interface Delivered_item_sender_ViewController : UIViewController<UITableViewDataSource,UITableViewDelegate>
{
    ...
    UILabel *DELIVERED_ON_LB;
    
    
    UILabel *DELIVERED_ON_LB_DYN;
