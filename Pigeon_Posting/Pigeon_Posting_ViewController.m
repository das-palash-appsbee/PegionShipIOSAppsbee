//
//  Pigeon_Posting_ViewController.m
//  PigeonShip
//
...
@interface Pigeon_Posting_ViewController (){
    NSString *test;
...
@implementation Pigeon_Posting_ViewController
...
- (void)viewDidLoad {
    ...
    [textlable setFrame:CGRectMake(20,10,100, 30)];
    ...
    [MTitle setFrame:CGRectMake(0,TopView.frame.origin.y+TopView.frame.size.height,self.view.frame.size.width, 40)];
    ...
    [Busines_name_LB setFrame:CGRectMake(30,MTitle.frame.origin.y+MTitle.frame.size.height,200, 30)];
    ...
    imgView_Busines_name = [[UIImageView alloc] initWithFrame:CGRectMake(Busines_name_TF.frame.origin.x+Busines_name_TF.frame.size.width, Busines_name_TF.frame.origin.y+17, 35, 35)];
...
//   imgView_Lname_drop = [[UIImageView alloc] initWithFrame:CGRectMake(Busines_name_TF_Drop.frame.origin.x+Busines_name_TF_Drop.frame.size.width, Busines_name_TF_Drop.frame.origin.y+17, 35, 35)];
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [self performSelectorInBackground:@selector(CalltheServer) withObject:nil];
    
    [self performSelector:@selector(CalltheServer_count) withObject:nil afterDelay:0.5];
    ...
    if ([[[NSUserDefaults standardUserDefaults]valueForKey:@"Switch"]isEqualToString:@"ON"]) {
        ...
        facke_view.hidden=NO;
        
        
        Reset.hidden=NO;
        Choose_size.hidden=NO;
        
        
        
        imgView_Busines_name.hidden=NO;
        imgView_Lname_drop.hidden=NO;
        
        Chosse_Pick_Up_address_LB.hidden=NO;
        Chosse_Pick_Up_address_TF.hidden=NO;
        Busines_name_LB.hidden=NO;
        Busines_name_TF.hidden=NO;
        Full_address_LB.hidden=NO;
        Full_address_TF.hidden=NO;
        App_setp_LB.hidden=NO;
        City_LB.hidden=NO;
        App_setp_TXT.hidden=NO;
        City_TXT.hidden=NO;
        State_LB.hidden=NO;
        Zip_LB.hidden=NO;
        State_TXT.hidden=NO;
        Zip_TXT.hidden=NO;
        Meet_With_Pigeon.hidden=NO;
        Me_BTN.hidden=NO;
        Me_LB.hidden=NO;
        Other_BTN.hidden=NO;
        Other_LB.hidden=NO;
        other_pic_up_LB.hidden=NO;
        other_pic_up_name.hidden=NO;
        Addition_info.hidden=NO;
        Addition_info_TXT_View.hidden=NO;
        ...
        MTitle_Drop.hidden=NO;
        Chosse_Pick_Up_address_LB_Drop.hidden=NO;
        Chosse_Pick_Up_address_TF_Drop.hidden=NO;
        Busines_name_LB_Drop.hidden=NO;
        Busines_name_TF_Drop.hidden=NO;
        Full_address_LB_Drop.hidden=NO;
        Full_address_TF_Drop.hidden=NO;
        App_setp_LB_Drop.hidden=NO;
        City_LB_Drop.hidden=NO;
        App_setp_TXT_Drop.hidden=NO;
        City_TXT_Drop.hidden=NO;
        State_LB_Drop.hidden=NO;
        Zip_LB_Drop.hidden=NO;
        State_TXT_Drop.hidden=NO;
        Zip_TXT_Drop.hidden=NO;
        Meet_With_Pigeon_Drop.hidden=NO;
        Me_BTN_Drop.hidden=NO;
        Me_LB_Drop.hidden=NO;
        Other_BTN_Drop.hidden=NO;
        Other_LB_Drop.hidden=NO;
        other_drop_down_LB.hidden=NO;
        other_drop_down_name.hidden=NO;
        Addition_info_Drop_Drop.hidden=NO;
        Addition_info_TXT_View_Drop.hidden=NO;
    ...
    else
    {
        ...
        facke_view.hidden=YES;
        
        
        Reset.hidden=YES;
        Choose_size.hidden=YES;
        
        Chosse_Pick_Up_address_LB.hidden=YES;
        Chosse_Pick_Up_address_TF.hidden=YES;
        Busines_name_LB.hidden=YES;
        Busines_name_TF.hidden=YES;
        Full_address_LB.hidden=YES;
        Full_address_TF.hidden=YES;
        App_setp_LB.hidden=YES;
        City_LB.hidden=YES;
        App_setp_TXT.hidden=YES;
        City_TXT.hidden=YES;
        State_LB.hidden=YES;
        Zip_LB.hidden=YES;
        State_TXT.hidden=YES;
        Zip_TXT.hidden=YES;
        Meet_With_Pigeon.hidden=YES;
        Me_BTN.hidden=YES;
        Me_LB.hidden=YES;
        Other_BTN.hidden=YES;
        Other_LB.hidden=YES;
        other_pic_up_LB.hidden=YES;
        other_pic_up_name.hidden=YES;
        Addition_info.hidden=YES;
        Addition_info_TXT_View.hidden=YES;
        ...
        MTitle_Drop.hidden=YES;
        Chosse_Pick_Up_address_LB_Drop.hidden=YES;
        Chosse_Pick_Up_address_TF_Drop.hidden=YES;
        Busines_name_LB_Drop.hidden=YES;
        Busines_name_TF_Drop.hidden=YES;
        Full_address_LB_Drop.hidden=YES;
        Full_address_TF_Drop.hidden=YES;
        App_setp_LB_Drop.hidden=YES;
        City_LB_Drop.hidden=YES;
        App_setp_TXT_Drop.hidden=YES;
        City_TXT_Drop.hidden=YES;
        State_LB_Drop.hidden=YES;
        Zip_LB_Drop.hidden=YES;
        State_TXT_Drop.hidden=YES;
        Zip_TXT_Drop.hidden=YES;
        Meet_With_Pigeon_Drop.hidden=YES;
        Me_BTN_Drop.hidden=YES;
        Me_LB_Drop.hidden=YES;
        Other_BTN_Drop.hidden=YES;
        Other_LB_Drop.hidden=YES;
        other_drop_down_LB.hidden=YES;
        other_drop_down_name.hidden=YES;
        Addition_info_Drop_Drop.hidden=YES;
        Addition_info_TXT_View_Drop.hidden=YES;
        
        imgView_Busines_name.hidden=YES;
        imgView_Lname_drop.hidden=YES;
...
- (void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray *)locations
{
    ...
    [[NSUserDefaults standardUserDefaults]setValue:[NSString stringWithFormat:@"%f",currentLocation.coordinate.latitude] forKey:@"latitude"];
    
      [[NSUserDefaults standardUserDefaults]setValue:[NSString stringWithFormat:@"%f",currentLocation.coordinate.longitude] forKey:@"longitude"];
...
-(void)CalltheServer_count
{
    if ([API connectedToInternet]==YES) {
        ...
        if ([[dict2 valueForKey:@"items"] isEqualToString:@"true"]) {
        ...
        {
            if ([[dict2 valueForKey:@"message"] isEqualToString:@"Access token expired"] || [[dict valueForKey:@"message"] isEqualToString:@"Security token mismatch ,Contact admin"]) {
...
{
    if (alertView.tag==1001 || alertView.tag==786) {
...
-(void)CalltheServer_Choose
{
    ...
    if ([API connectedToInternet]==YES) {
        ...
        if ([[dict valueForKey:@"status"] isEqualToString:@"true"]) {
            ...
            [[NSUserDefaults standardUserDefaults]setValue:[dict valueForKey:@"Total_price"] forKey:@"Total_price"];
            ...
            [[NSUserDefaults standardUserDefaults]setValue:@"YES" forKey:@"Pigeon_posting"];
            [[NSUserDefaults standardUserDefaults]synchronize];
...
-(void)CalltheServer_google_place:(NSString *)string
{
    ...
    if ([API connectedToInternet]==YES) {
        ...
        google_api= [API HomeScreen:[NSString stringWithFormat:@"%@%@",@"https://maps.googleapis.com/maps/api/place/autocomplete/json?location=35.143066,-116.103783&key=AIzaSyC-RC_TJldvY86tz6HLMxI54bAvZBFBtJ8& types=@“geocode”&components=country:us&input=",string]];
