//
//  Expired_items_sender_ViewController.m
//  Pigeonship
//
...
#import "Expired_items_sender_deatil.h"
#import "Utility.h"

@interface Expired_items_sender_ViewController ()

@end

@implementation Expired_items_sender_ViewController
...
-(void)CalltheServer
{
    ...
    if ([API connectedToInternet]==YES) {
        ...
        if ([[dict valueForKey:@"status"] isEqualToString:@"true"]) {
            ...
            textlable.text = [NSString stringWithFormat:@"Total %d items are Expired",[[dict valueForKey:@"data"]count]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   // Pack_type_dyn_LB.text= [[[dict valueForKey:@"data"]objectAtIndex:indexPath.row]valueForKey:@"Package_Type"];
    ...
    DELIVERED_ON_LB.text= @"Expired On";
    ...
    DELIVERED_ON_LB_DYN.text= [[[dict valueForKey:@"data"]objectAtIndex:indexPath.row]valueForKey:@"Package_Expiredon"];
    DELIVERED_ON_LB_DYN.textColor=[UIColor whiteColor];
...
{
    Expired_items_sender_deatil *objItem_Detail_ViewController=[[Expired_items_sender_deatil alloc]init];
