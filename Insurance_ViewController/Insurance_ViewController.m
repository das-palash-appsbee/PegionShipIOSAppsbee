...
- (void)viewDidLoad {
    ...
    [Insurance_phone_number_TXT setFont:[UIFont fontWithName:@"bariol-regular" size:14.0]];
    ...
    facke_view.frame= CGRectMake(30, Insurance_phone_number_TXT.frame.origin.y+100,self.view.frame.size.width-60, 60.0);
...
#pragma mark - -*********************
#pragma mark   Keyboard Top Cancel and Done Methods
#pragma mark - -*********************
...
#pragma mark - -*********************
#pragma mark   Fetch Current Date Method
#pragma mark - -*********************
...
-(void)Next:(UIButton *)sender
{
    ...
    else
    {
        ...
        [Dic_Insurance setValue:Insurance_name_TXT.text forKey:@"Insurance_name_TXT"];
        [Dic_Insurance setValue:Insurance_Provider_TXT.text forKey:@"Insurance_Provider_TXT"];
        [Dic_Insurance setValue:Policy_Number_TXT.text forKey:@"Policy_Number_TXT"];
        [Dic_Insurance setValue:Expiration_TXT.text forKey:@"Expiration_TXT"];
        [Dic_Insurance setValue:Insurance_phone_number_TXT.text forKey:@"Insurance_phone_number_TXT"];
        ...
        NSLog(@"%@",[[[NSUserDefaults standardUserDefaults]valueForKey:@"InsuranceView"]valueForKey:@"Insurance_name_TXT"]);
