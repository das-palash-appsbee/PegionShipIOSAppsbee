...
@interface Close_items_ViewController ()

@end

@implementation Close_items_ViewController
...
-(void)CalltheServer
{
    ...
    if ([API connectedToInternet]==YES) {
        ...
        if ([[dict valueForKey:@"status"] isEqualToString:@"true"]) {
            ...
            textlable.text = [NSString stringWithFormat:@"Total %d items are Closed",[[dict valueForKey:@"Package_Deliver_Detail"]count]];
...
{
        Close_items_Deatils *objItem_Detail_ViewController=[[Close_items_Deatils alloc]init];
