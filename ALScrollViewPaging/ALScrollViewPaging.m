...
- (void)setHasPageControl:(BOOL)hasPageControl {
    ...
    if (hasPageControl) {
        ...
        NSLog(@"%f",([[UIScreen mainScreen]bounds].size.width-35)/2);
        
        //set the frame of the page control
        [pageControl setFrame:CGRectMake(([[UIScreen mainScreen]bounds].size.width-35)/2,  [[UIScreen mainScreen]bounds].size.height-230,pWidth, 36)];
        //set target and selector for page control
        [pageControl addTarget:self action:@selector(changePage:) forControlEvents:UIControlEventValueChanged];
        //set colors for indicators
        [pageControl setPageIndicatorTintColor:[UIColor colorWithRed:52.0f/255.0f green:51.0f/255.0f blue:49.0f/255.0f alpha:1.0]];
        [pageControl setCurrentPageIndicatorTintColor:[UIColor colorWithRed:255.0f/255.0f green:179.0f/255.0f blue:0.0f/255.0f alpha:1.0]];
...
//    ViewController *objHelp=[[ViewController alloc]init];
//    
//    
//    [objHelp controll:self.currentPage];
