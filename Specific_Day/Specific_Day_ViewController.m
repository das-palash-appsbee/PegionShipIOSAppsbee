...
#import "MFSideMenu.h"
#import "Utility.h"
@interface Specific_Day_ViewController ()

@end

@implementation Specific_Day_ViewController
...
- (void)viewDidLoad {
    ...
    CGRect pickerFrame = CGRectMake(0,MTitle.frame.origin.y+MTitle.frame.size.height+20,0,0);
   ...
   myPicker = [[UIDatePicker alloc] initWithFrame:pickerFrame];
    ...
    //    ///////////////////////////// Radio  Button\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
        ...
        Check_Uncheck.frame = CGRectMake(30,myPicker.frame.origin.y+myPicker.frame.size.height,25,25);
        ...
        [Demo_LB setFrame:CGRectMake(60,myPicker.frame.origin.y+myPicker.frame.size.height+1,100, 22)];
        Demo_LB.backgroundColor=[UIColor clearColor];
        Demo_LB.textColor=[UIColor whiteColor];
        Demo_LB.userInteractionEnabled=NO;
        [Demo_LB setFont:[UIFont fontWithName:@"bariol-regular" size:14.0]];
        Demo_LB.text= @"ANY TIME";
        ...
        RIGHT_Check_Uncheck.frame = CGRectMake(180,myPicker.frame.origin.y+myPicker.frame.size.height,25,25);
        ...
        [RIGHT_Demo_LB setFrame:CGRectMake(210,myPicker.frame.origin.y+myPicker.frame.size.height+1,100, 22)];
        ...
        [RIGHT_Demo_LB setFont:[UIFont fontWithName:@"bariol-regular" size:14.0]];
    ...
    [Upon_LB setFrame:CGRectMake(30,SELECT_TIME.frame.origin.y+SELECT_TIME.frame.size.height+20,300, 22)];
    ...
    Check_Box = [[UIImageView alloc] initWithFrame:CGRectMake(8, Payment_text_LB.frame.origin.y+45, 30, 30)];
    ...
    [TermCondision setFrame:CGRectMake(40,Payment_text_LB.frame.origin.y+37,250, 50)];
    ...
    PigenShip_it.frame = CGRectMake(30, TermCondision.frame.origin.y+44,self.view.frame.size.width-60, 40.0);
    ...
    if (check_value==true) {
        ...
        
        {
            ...
            if ([TIME_VALUE isEqualToString:@""] || [TIME_VALUE length]==0) {
              ...
              //  NSLog(@"User's current time in their preference format:%@",TIME_VALUE);
                
            }
            
            
            if ([DATE_VALUE isEqualToString:@""] || [DATE_VALUE length]==0) {
...
//                [dateFormatter setTimeZone:timeZone];
                ...
                DATE_VALUE = [[dateFormatter stringFromDate:currDate]retain];
...
- (void)pickerChanged:(id)sender
{
    ...
    [dateFormatters setTimeZone:[NSTimeZone systemTimeZone]];
    DATE_VALUE = [[dateFormatters stringFromDate:myPicker.date]retain];
    
    
     NSLog(@"value: %@",DATE_VALUE);
}
