//
//  Delivered_Item_ViewController.m
//  Pigeonship
//
...
@interface Delivered_Item_ViewController ()

@end

@implementation Delivered_Item_ViewController
...
-(void)CalltheServer
{
    ...
    if ([API connectedToInternet]==YES) {
        ...
        if ([[dict valueForKey:@"status"] isEqualToString:@"true"]) {
            ...
            textlable.text = [NSString stringWithFormat:@"Total %d items are Delivered",[[dict valueForKey:@"Package_Deliver_Detail"]count]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
 ...
 stringByAppendingString:@"(Classified)"];
    ...
    Delivered_Before_dyn_LB.text= [[[dict valueForKey:@"Package_Deliver_Detail"]objectAtIndex:indexPath.row]valueForKey:@"Package_Delivery"];
    Delivered_Before_dyn_LB.textColor=[UIColor whiteColor];
...
{
        Delivered_Item_Detail_Page *objItem_Detail_ViewController=[[Delivered_Item_Detail_Page alloc]init];
