...
@interface Expired_items_sender_deatil ()

@end

@implementation Expired_items_sender_deatil
...
- (void)viewDidLoad {
    ...
    Accepted_On_LB_ST.text=@"Posted On";
    Accepted_On_LB_ST.backgroundColor=[UIColor clearColor];
    ...
    Package_Delivered_On_LB_ST.text=@"Delivery Date";
    Package_Delivered_On_LB_ST.backgroundColor=[UIColor clearColor];
    ...
    Accepted_By_Pigeon_LB_ST.text=@"Expired On";
...
-(void)CalltheServer
{
    ...
    if ([API connectedToInternet]==YES) {
        ...
        if ([[dict valueForKey:@"status"] isEqualToString:@"true"]) {
            ...
            Accepted_On_LB_DYT.text=[[dict valueForKey:@"Package_Detail"]valueForKey:@"Package_posted_On"];
            Package_Delivered_On_LB_DYT.text=[[dict valueForKey:@"Package_Detail"]valueForKey:@"Package_DeliverBy"];
            Accepted_By_Pigeon_LB_DYT.text=[[dict valueForKey:@"Package_Detail"]valueForKey:@"Package_Expiredon"];
            ...
            if ([[[dict valueForKey:@"Package_Detail"]valueForKey:@"classified"]isEqualToString:@"TRUE"])
            {
                ...
                if ([[[dict valueForKey:@"Package_Detail"]valueForKey:@"return"]isEqualToString:@"FALSE"]) {
                    ...
                    string_Package_price=[NSString stringWithFormat:@"Refund :  %@",[[dict valueForKey:@"Package_Detail"]valueForKey:@"total"]];
                    
                    str_Package_price = [[NSMutableAttributedString alloc] initWithString:string_Package_price];
                    
                    [str_Package_price addAttribute:NSForegroundColorAttributeName value:[UIColor colorWithRed:180.0f/255.0f green:180.0f/255.0f blue:179.0f/255.0f alpha:1.0] range:NSMakeRange(0,9)];
                    [str_Package_price addAttribute:NSForegroundColorAttributeName value:[UIColor whiteColor] range:NSMakeRange(10, [string_Package_price length]-11)];
