//
//  Close_items_sender_ViewController.m
//  Pigeonship
//
...
@interface Close_items_sender_ViewController ()

@end

@implementation Close_items_sender_ViewController
...
-(void)CalltheServer
{
    ...
    if ([API connectedToInternet]==YES) {
        ...
        if ([[dict valueForKey:@"status"] isEqualToString:@"true"]) {
            ...
            NSLog(@"%lu",(unsigned long)[[dict valueForKey:@"data"]count]);
            
            
            textlable.text = [NSString stringWithFormat:@"Total %d items are Closed",[[dict valueForKey:@"data"]count]];
            
            
            
            NSLog(@"%@",[dict valueForKey:@"data"]);
            NSLog(@"%@",[[[dict valueForKey:@"data"]objectAtIndex:0]valueForKey:@"Delivery_date"]);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Middle_Round_LB.text=[NSString stringWithFormat:@"$%@",[[[dict valueForKey:@"data"]objectAtIndex:indexPath.row]valueForKey:@"Package_price"]];
    ...
    Middle_Left_Address_LB.text= [[[dict valueForKey:@"data"]objectAtIndex:indexPath.row]valueForKey:@"Package_Origin"];
    Middle_Left_Address_LB.textColor=[UIColor whiteColor];
    ...
    Middle_Right_Address_LB.text= [[[dict valueForKey:@"data"]objectAtIndex:indexPath.row]valueForKey:@"Package_Destination"];
    Middle_Right_Address_LB.textColor=[UIColor whiteColor];
    ...
    [Pack_type_dyn_LB setFrame:CGRectMake(15,Pack_type_str_LB.frame.origin.y+20,190, 30)];
    ...
    if ([[[[dict valueForKey:@"data"]objectAtIndex:indexPath.row]valueForKey:@"classified"]isEqualToString:@"TRUE"]) {
        
        Pack_type_dyn_LB.text=[[[[dict valueForKey:@"data"]objectAtIndex:indexPath.row]valueForKey:@"Package_Type"] stringByAppendingString:@"(Classified)"];
    ...
    {
        Pack_type_dyn_LB.text= [[[dict valueForKey:@"data"]objectAtIndex:indexPath.row]valueForKey:@"Package_Type"];
    }
   ...
   // Pack_type_dyn_LB.text= [[[dict valueForKey:@"data"]objectAtIndex:indexPath.row]valueForKey:@"Package_Type"];
    ...
    Delivered_Before_dyn_LB.text= [[[dict valueForKey:@"data"]objectAtIndex:indexPath.row]valueForKey:@"Package_Date"];
    Delivered_Before_dyn_LB.textColor=[UIColor whiteColor];
    ...
    DELIVERED_ON_LB.text= @"Delivered On";
    ...
    DELIVERED_ON_LB_DYN.text= [[[dict valueForKey:@"data"]objectAtIndex:indexPath.row]valueForKey:@"Package_DeliveryDate"];
    DELIVERED_ON_LB_DYN.textColor=[UIColor whiteColor];
...
{
    Close_items_sender_detail *objItem_Detail_ViewController=[[Close_items_sender_detail alloc]init];
    objItem_Detail_ViewController.Pack_Key=[[[dict valueForKey:@"data"]objectAtIndex:sender.tag]valueForKey:@"Package_Id"];
