//
//  MORE_INFO_DETAIL_ViewController.m
//  PigeonShip
//
...
@interface MORE_INFO_DETAIL_ViewController ()

@end

@implementation MORE_INFO_DETAIL_ViewController
...
- (void)viewDidLoad {
    ...
    webView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 50, [[UIScreen mainScreen]bounds].size.width, [[UIScreen mainScreen]bounds].size.height-50)];
