//
//  Pigeon_posting_detail_ViewController.h
//  PigeonShip
//
...
@interface Pigeon_posting_detail_ViewController : UIViewController<UITextFieldDelegate,UIAlertViewDelegate>
{
       AppDelegate *appDelegate;
    UIScrollView *scrollview;
    UILabel *MTitle;
    
     UIButton *Refress_BTN;
    UIButton *Next_BTN;
    UIButton *Back_BTN;
    UIView *TopView;
