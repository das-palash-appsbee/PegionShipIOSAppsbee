//
//  EditProfile_LIST_ViewController.m
//  Pigeonship
//
...
#import "EditProfile_LIST_ViewController.h"
#import "MFSideMenu.h"
...
@interface EditProfile_LIST_ViewController ()

@end

@implementation EditProfile_LIST_ViewController
...
- (void)viewDidLoad {
    ...
    [self setupMenuBarButtonItems];
     ...
     List_item=[[NSMutableArray alloc]initWithObjects:@"Profile Pic",@"Insurance",@"License",@"Vehicle",@"Account Info",@"Bank Info",@"Change Password", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    EDIT_VIEW_Name.frame=CGRectMake(60,19, mtableview.frame.size.width-120, 30);
    ...
    [EDIT_VIEW_Name setFont:[UIFont fontWithName:@"bariol-regular" size:14.0]];
    ///   }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self.navigationController  pushViewController:demoController animated:YES];
        ...
        Edit_Insurance_ViewController *demoController = [[Edit_Insurance_ViewController alloc] init];
        [self.navigationController  pushViewController:demoController animated:YES];
...
//        [self.menuContainerViewController setMenuState:MFSideMenuStateClosed];
        ...
        Edit_multi_vechile_detail_ViewController *demoController = [[Edit_multi_vechile_detail_ViewController alloc] init];
        [self.navigationController  pushViewController:demoController animated:YES];
...
//        UIAlertView *alter=[[UIAlertView alloc]initWithTitle:@"Log out" message:@"Are you sure you want to log out" delegate:self cancelButtonTitle:@"Yes" otherButtonTitles:@"No",nil];
//        
//        [alter show];
//        
    ...
    {
        Edit_Bank_Info_ViewController *demoController = [[Edit_Bank_Info_ViewController alloc] init];
        [self.navigationController  pushViewController:demoController animated:YES];
