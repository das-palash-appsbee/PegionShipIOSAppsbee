//
//  Accepted_item_ViewController.h
//  Pigeonship
//
...
@interface Accepted_item_ViewController : UIViewController<UITableViewDataSource,UITableViewDelegate>
{
    
      UIButton *Slider_Button;
      UIButton *Pick_up_Button;
      UIButton *Dropp_off_Button;
