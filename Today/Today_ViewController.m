...
#import "MFSideMenu.h"
#import "Utility.h"
@interface Today_ViewController ()

@end

@implementation Today_ViewController
...
- (void)viewDidLoad {
    ...
    [Demo_LB setFrame:CGRectMake(62,MTitle.frame.origin.y+MTitle.frame.size.height+1,150, 20)];
    ...
    [RIGHT_Demo_LB setFrame:CGRectMake(211,MTitle.frame.origin.y+MTitle.frame.size.height+1,150, 20)];
