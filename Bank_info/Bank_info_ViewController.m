...
@interface Bank_info_ViewController ()

@end

@implementation Bank_info_ViewController
...
//
    ...
    [Account_Type_LB setFrame:CGRectMake(30,Account_Number_TXT.frame.origin.y+50,100, 30)];
    ...
    [Date_Birth_LB setFrame:CGRectMake(30,Account_Type_TXT.frame.origin.y+50,100, 30)];
    ...
    CheckGround.image=[UIImage imageNamed:@"Untitled-2.png"];
    CheckGround.frame=CGRectMake((self.view.frame.size.width-254)/2, facke_view.frame.origin.y+facke_view.frame.size.height+5, 254,  105);
...
-(void)Next:(UIButton *)sender
{
    ...
    [[NSUserDefaults standardUserDefaults]setObject:@"True" forKey:@"Bank_Info_Statues"];
    ...
    {
        UIAlertView *alert2 = [[UIAlertView alloc] initWithTitle:@"Alert" message:@"Routing Number Lenghth maximum 9 character" delegate:self cancelButtonTitle:nil otherButtonTitles:@"OK", nil];
        [alert2 show];
    }

    else if (Account_Number_TXT.text.length>15)
    {
        UIAlertView *alert2 = [[UIAlertView alloc] initWithTitle:@"Alert" message:@"Account Number Lenghth maximum 15 character" delegate:self cancelButtonTitle:nil otherButtonTitles:@"OK", nil];
        [alert2 show];
    }
    ...
    else
    {
        ...
        [Dic_Bank_info setValue:Account_name_TXT.text forKey:@"Account_name_TXT"];
        [Dic_Bank_info setValue:Routing_Number_TXT.text forKey:@"Routing_Number_TXT"];
        [Dic_Bank_info setValue:Account_Number_TXT.text forKey:@"Account_Number_TXT"];
        [Dic_Bank_info setValue:Account_Type_TXT.text forKey:@"Account_Type_TXT"];
        [Dic_Bank_info setValue:Date_Birth_TXT.text forKey:@"Date_Birth_TXT"];
...
-(void)CallTheServer
{
    if ([API connectedToInternet]==YES) {
        ...
        NSObject * object = [prefs objectForKey:@"Add_route"];
        if(object != nil){
            NSData *jsonData = [NSJSONSerialization dataWithJSONObject:[[NSUserDefaults standardUserDefaults]valueForKey:@"Add_route"] options:0 error:nil];
            
            // Checking the format
            NSLog(@"%@",[[NSString alloc] initWithData:jsonData encoding:NSUTF8StringEncoding]);
            
            
            datavall=[[NSString alloc] initWithData:jsonData encoding:NSUTF8StringEncoding];
        ...
        NSString *responseString = [API makeCallPostData_ALL:[NSString stringWithFormat:@"security_token=%@&access_token=%@&insurance_name=%@&insurance_provider=%@&insurance_number=%@&insurance_phone_number=%@&expiration_date=%@&vehicle_data=%@&account_name=%@&routing_number=%@&account_number=%@&account_type=%@&date_of_birth=%@&user_id=%@&Bank_Info_Statues=%@&Vechile_info_Statues=%@&Insurance_Info_Statues=%@&route=%@",[Utility Pigeon_security_token],[[NSUserDefaults standardUserDefaults]valueForKey:@"access_token"],[[[NSUserDefaults standardUserDefaults]valueForKey:@"InsuranceView"]valueForKey:@"Insurance_name_TXT"],[[[NSUserDefaults standardUserDefaults]valueForKey:@"InsuranceView"]valueForKey:@"Insurance_Provider_TXT"],[[[NSUserDefaults standardUserDefaults]valueForKey:@"InsuranceView"]valueForKey:@"Policy_Number_TXT"],[[[NSUserDefaults standardUserDefaults]valueForKey:@"InsuranceView"]valueForKey:@"Insurance_phone_number_TXT"],
[[[NSUserDefaults standardUserDefaults]valueForKey:@"InsuranceView"]valueForKey:@"Expiration_TXT"],
  [[NSUserDefaults standardUserDefaults]valueForKey:@"Vechile_info_View"],[[[NSUserDefaults standardUserDefaults]valueForKey:@"Bank_info_View"]valueForKey:@"Account_name_TXT"],
