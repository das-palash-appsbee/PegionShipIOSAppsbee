//
//  Accepted_items_sender_ViewController.h
//  Pigeonship
//
...
@interface Accepted_items_sender_ViewController : UIViewController<UITableViewDataSource,UITableViewDelegate>
{
    ...
    UILabel *ACCEPTED_BY_PIGEON_LB;
    
    
    UILabel *ACCEPTED_BY_PIGEON_LB_DYN;
