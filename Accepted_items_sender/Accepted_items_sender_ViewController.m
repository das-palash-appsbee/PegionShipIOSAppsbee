//
//  Accepted_items_sender_ViewController.m
//  Pigeonship
//
...
@interface Accepted_items_sender_ViewController ()

@end

@implementation Accepted_items_sender_ViewController
...
-(void)CalltheServer
{
    ...
    if ([API connectedToInternet]==YES) {
        ...
        if ([[dict valueForKey:@"status"] isEqualToString:@"true"]) {
            ...
            NSLog(@"%lu",(unsigned long)[[dict valueForKey:@"Package_Deliver_Detail"]count]);
            
            
            textlable.text = [NSString stringWithFormat:@"Total %d items are Accepted",[[dict valueForKey:@"Package_Deliver_Detail"]count]];
...
{
    return [[dict valueForKey:@"Package_Deliver_Detail"]count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ///////////////////////////////////   BackGround view /////////////////////////////////////////////////
    mtable_bacground=[[UIView alloc]initWithFrame:CGRectMake(0, 0, mtableview.frame.size.width, 220)];
    mtableview.backgroundColor=[UIColor clearColor];
    ...
    Middle_Round_LB.text=[NSString stringWithFormat:@"$%@",[[[dict valueForKey:@"Package_Deliver_Detail"]objectAtIndex:indexPath.row]valueForKey:@"Package_price"]];
    ...
    Middle_Left_Address_LB.text= [[[dict valueForKey:@"Package_Deliver_Detail"]objectAtIndex:indexPath.row]valueForKey:@"Package_Origin"];
    Middle_Left_Address_LB.textColor=[UIColor whiteColor];
    ...
    Middle_Right_Address_LB.text= [[[dict valueForKey:@"Package_Deliver_Detail"]objectAtIndex:indexPath.row]valueForKey:@"Package_Destination"];
    Middle_Right_Address_LB.textColor=[UIColor whiteColor];
    ...
    if ([[[[dict valueForKey:@"Package_Deliver_Detail"]objectAtIndex:indexPath.row]valueForKey:@"classified"]isEqualToString:@"TRUE"]) {
        
        Pack_type_dyn_LB.text=[[[[dict valueForKey:@"Package_Deliver_Detail"]objectAtIndex:indexPath.row]valueForKey:@"Package_Type"] stringByAppendingString:@"(Classified)"];
    ...
    {
        Pack_type_dyn_LB.text= [[[dict valueForKey:@"Package_Deliver_Detail"]objectAtIndex:indexPath.row]valueForKey:@"Package_Type"];
    }
    ...
    Delivered_Before_dyn_LB.text= [[[dict valueForKey:@"Package_Deliver_Detail"]objectAtIndex:indexPath.row]valueForKey:@"Package_Date"];
    Delivered_Before_dyn_LB.textColor=[UIColor whiteColor];
    ...
    ACCEPTED_BY_PIGEON_LB = [[UILabel alloc] init];
    ACCEPTED_BY_PIGEON_LB.textColor = [UIColor blackColor];
    [ACCEPTED_BY_PIGEON_LB setFrame:CGRectMake(15,Pack_type_dyn_LB.frame.origin.y+Pack_type_dyn_LB.frame.size.height+2,150, 30)];
    ACCEPTED_BY_PIGEON_LB.backgroundColor=[UIColor clearColor];
    ACCEPTED_BY_PIGEON_LB.textColor=[UIColor whiteColor];
    ACCEPTED_BY_PIGEON_LB.userInteractionEnabled=NO;
    [ACCEPTED_BY_PIGEON_LB setFont:[UIFont fontWithName:@"bariol-regular" size:16.0]];
    ACCEPTED_BY_PIGEON_LB.text= @"Accepted by Pigeon";
    ACCEPTED_BY_PIGEON_LB.textColor=[UIColor colorWithRed:196.0f/255.0f green:196.0f/255.0f blue:196.0f/255.0f alpha:1.0];
    ACCEPTED_BY_PIGEON_LB.textAlignment=NSTextAlignmentLeft;
    [mtable_bacground addSubview:ACCEPTED_BY_PIGEON_LB];
    
    
      //    ////////////////////////////   Pack_type_Dynamic Lable \\\\\\\\\\\\\\\\\\\\\\\\
    
    
    ACCEPTED_BY_PIGEON_LB_DYN = [[UILabel alloc] init];
    ACCEPTED_BY_PIGEON_LB_DYN.textColor = [UIColor blackColor];
    [ACCEPTED_BY_PIGEON_LB_DYN setFrame:CGRectMake(15,ACCEPTED_BY_PIGEON_LB.frame.origin.y+20,200, 30)];
    ACCEPTED_BY_PIGEON_LB_DYN.backgroundColor=[UIColor clearColor];
    ACCEPTED_BY_PIGEON_LB_DYN.textColor=[UIColor whiteColor];
    ACCEPTED_BY_PIGEON_LB_DYN.userInteractionEnabled=NO;
    [ACCEPTED_BY_PIGEON_LB_DYN setFont:[UIFont fontWithName:@"bariol-regular" size:16.0]];
    ACCEPTED_BY_PIGEON_LB_DYN.text= [[[dict valueForKey:@"Package_Deliver_Detail"]objectAtIndex:indexPath.row]valueForKey:@"Package_Acceptedby"];
    ACCEPTED_BY_PIGEON_LB_DYN.textColor=[UIColor whiteColor];
    ACCEPTED_BY_PIGEON_LB_DYN.textAlignment=NSTextAlignmentLeft;
    [mtable_bacground addSubview:ACCEPTED_BY_PIGEON_LB_DYN];
    ...
    View_Detail_BTN.frame = CGRectMake((self.view.frame.size.width-110)/2, ACCEPTED_BY_PIGEON_LB_DYN.frame.origin.y+27,110, 30);
...
{
    Accepted_items_sender_detail *objItem_Detail_ViewController=[[Accepted_items_sender_detail alloc]init];
    
    
    
    
    objItem_Detail_ViewController.Pack_Key=[[[dict valueForKey:@"Package_Deliver_Detail"]objectAtIndex:sender.tag]valueForKey:@"Package_Id"];
